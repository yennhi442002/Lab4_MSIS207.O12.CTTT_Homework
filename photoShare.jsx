  ...
  render() {
    return (
      ...
      <Grid container spacing={8}>
        ...
        <div className="UIT-main-topbar-buffer"/>
        <Grid item sm={3}>
          <Paper className="UIT-main-grid-item">
            <UserList />
          </Paper>
        </Grid>
        <Grid item sm={9}>
          <Paper className="UIT-main-grid-item">
            ...
            <Route exact path="/"
              ...
              <Route path="/users/:userId"
                render={ props => <UserDetail {...props} onChangeView={this.onChangeView} /> }
              />
              <Route path="/photos/:userId"
                render ={ props => <UserPhotos {...props} onChangeView={this.onChangeView} /> }
              />
